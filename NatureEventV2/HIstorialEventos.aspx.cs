        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if ((int)Session["user"] == 1)
                {
                    ...
                    {
                        ContentArea.Controls.Add(new LiteralControl("<div style='border-style:solid; border-width:thin; margin:auto; width:50%; background-color:white;' class='col-md-6 col-lg-6 position-static p-4 mb-3'><h5>" + evento.Nombre + "</h5><p>" + evento.Descripcion.ToString() + "</p>"));
