    ...
    public partial class RegistroEmpresa : System.Web.UI.Page
    {
        ...
        protected void validar_empresa_click(object sender, EventArgs e)
        {
            try
            {
                ...
                bool dniValido = validarNIF(TxtCIF.Text);
        ...
        public bool validarEmail()
        {
            try
            {
                ...
                if (Regex.IsMatch(TxtEmail.Text, expresion) && (Regex.Replace(TxtEmail.Text, expresion, String.Empty).Length == 0) && (usuario.ValidarExistenciaEmail(TxtEmail.Text) == null))
                {
                    return true;
                }
                else
